...
paths = [
    ...
    '/mnt/hdd/yw/models/feat/cub-con-pre.pth',
    '/mnt/hdd/yw/models/feat/feat-1-shot.pth',
    '/mnt/hdd/yw/models/feat/deepsets-1-shot.pth'
]

commands = [
   f"python test_fsl.py --model_class ProtoNet --backbone_class ConvNet --dataset cub --model_path {paths[2]} --spt_expansion 1 --qry_expansion 1 --aug_type sim-mix-up",
